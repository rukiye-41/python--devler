...
##tek_sayi=lambda sayi:sayi%2!=0
cift_sayi=lambda sayi:sayi%2==0
ucun_kati=lambda sayi:sayi%3==0
besin_kati=lambda sayi:sayi%5==0
...
def sayi_kontrol(ilksayi,sonsayi):
    ...
    liste=list(range(int(ilksayi),int(sonsayi)))
    print(liste)
    for sayi in liste:
        cift_sayi(sayi)
        ucun_katı(sayi)
...
while True:
    ...
    if secim=="1":
        ...
        print(sayi_kontrol(int(ilksayi),int(sonsayi)))
        continue   
